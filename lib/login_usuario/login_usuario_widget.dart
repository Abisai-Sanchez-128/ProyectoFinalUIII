import '../cliente6campos/cliente6campos_widget.dart';
...
class LoginUsuarioWidget extends StatefulWidget {
  const LoginUsuarioWidget({Key key}) : super(key: key);

  @override
  _LoginUsuarioWidgetState createState() => _LoginUsuarioWidgetState();
}
              ...
              child: FFButtonWidget(
                onPressed: () async {
                  await Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => Cliente6camposWidget(),
                    ),
                  );
                },
                text: 'Registrate',
